...
* **Imaging:** use locking when rendering images ([5b0a7b3](https://github.com/labor-digital/typo3-frontend-api/commit/5b0a7b3b21926488335f7fa3cede598840212be2))
...
* **RteContentParser:** set htmlSanitize into config when possible ([fd48ee6](https://github.com/labor-digital/typo3-frontend-api/commit/fd48ee61527b1eb74d05d3744a967dfff3848f1b))
...
* **Resource\ContentElement:** HTTP exceptions thrown in a content element controller were not handled correctly ([ec5a360](https://github.com/labor-digital/typo3-frontend-api/commit/ec5a360264eb7d290437c355f7f6b0a518ce56c5))
