...
class ContentElementPreProcessorEvent {
	 ...
	 */
	public function __construct(string $cType, array $row, string $controllerClass, ServerRequestInterface $request,
								bool $isFrontend, array $config, array $environment) {
		$this->cType = $cType;
		$this->row = $row;
