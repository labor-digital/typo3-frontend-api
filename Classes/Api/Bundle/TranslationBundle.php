...
use LaborDigital\T3fa\Api\Resource\TranslationResource;
...
class TranslationBundle implements ApiBundleInterface
{
    /**
     * @inheritDoc
     */
    ...
    {
        $collector->register(TranslationResource::class);
    }
