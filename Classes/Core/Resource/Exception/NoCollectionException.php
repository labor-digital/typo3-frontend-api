...
class NoCollectionException extends NotImplementedException implements HttpConvertibleExceptionInterface
{
    public function __construct(string $resourceType, $code = 0, Throwable $previous = null)
    {
        $message = 'The resource "' . $resourceType . '" does not support a "collection" request, use a unique id instead';
