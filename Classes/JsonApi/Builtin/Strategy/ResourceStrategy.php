...
class ResourceStrategy extends AbstractResourceStrategy
{
    ...
    public function invokeRouteCallable(Route $route, ServerRequestInterface $request): ResponseInterface
    {
        ...
        if ($response instanceof QueryResultInterface) {
        ...
        if (is_string($route->getVars()["relationship"])) {
            ...
            if (! isset($config->includes[$propertyName])) {
                throw new NotFoundException("Relation for property: $propertyName was not found!");
            }
            ...
            if ($propertyConf["isCollection"]) {
                $subItem = new Collection($data, $transformer, $propertyConf["resourceType"]);
            } else {
                $subItem = new Item($data, $transformer, $propertyConf["resourceType"]);
            }
