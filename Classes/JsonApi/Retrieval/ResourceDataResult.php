...
class ResourceDataResult implements SelfTransformingInterface {
	...
	public function getDataNormalized(): array {
		...
		if ($this->isCollection()) $obj = $hydrator->hydrateCollection($document);
	...
	public function isCollection(): bool {
		if (isset($this->data["meta"]) && $this->data["meta"]["pagination"]) return TRUE;
		return isset($this->data["data"]) && isset($this->data["data"][0]) &&
			is_array($this->data["data"][0]) && !isset($this->data["attributes"]);
	}
	...
	public function getResourceType(): ?string {
		...
		} else if (isset($this->data["data"]) && isset($this->data["data"][0]) && isset($this->data["data"][0])
