 ...
 *
 * Last modified: 2021.05.16 at 16:48
 */
...
{
    protected $configureMethod = 'configureApiRouting';
    ...
    {
        $configurator->registerInterface(ConfigureApiRoutingInterface::class);
        $configurator->registerDefaultConfigClass(DefaultApiRoutingConfig::class);
    ...
    {
        return ApiRoutingConfigurator::class;
    }
