...
use LaborDigital\T3fa\Resource\Transformer\FileTransformer;
use TYPO3\CMS\Core\Resource\Exception\ResourceDoesNotExistException;

class FileReference implements ResourceInterface
{
    /**
    ...
    public static function configure(ResourceConfigurator $configurator, SiteConfigContext $context): void
    {
        ...
        $configurator->registerClass(\TYPO3\CMS\Core\Resource\FileReference::class);
        $configurator->registerClass(\TYPO3\CMS\Extbase\Domain\Model\FileReference::class);
    }
