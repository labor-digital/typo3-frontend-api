 ...
 *
 * Last modified: 2021.06.02 at 19:44
 */

declare(strict_types=1);


namespace LaborDigital\T3fa\Resource\Factory\Page\Generator;
...
use LaborDigital\T3fa\Resource\Factory\Page\PageData;
...
class InfoGenerator
{
     ...
     *
     * @param   \LaborDigital\T3fa\Resource\Factory\Page\PageData  $data
     */
...
//        $info = $this->eventDispatcher->dispatch(new PageDataPageInfoFilterEvent($data->pid, $info, $data))->getInfo();
     ...
     *
     * @param   \LaborDigital\T3fa\Resource\Factory\Page\PageData  $pageData
     *
     * @return string|null
     */
