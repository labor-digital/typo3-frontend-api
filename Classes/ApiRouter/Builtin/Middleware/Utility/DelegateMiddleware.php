...
class DelegateMiddleware implements MiddlewareInterface
{
    ...
    /**
     * DelegateMiddleware constructor.
     *
     * @param   \Psr\Http\Server\RequestHandlerInterface  $delegateHandler
     */
    public function __construct(RequestHandlerInterface $delegateHandler)
    {
