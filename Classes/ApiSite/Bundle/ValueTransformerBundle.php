...
use LaborDigital\T3fa\Resource\Transformer\DateTransformer;
use LaborDigital\T3fa\Resource\Transformer\TypoLinkTransformer;
use Psr\Http\Message\UriInterface;
use TYPO3\CMS\Extbase\Mvc\Web\Routing\UriBuilder;

class ValueTransformerBundle implements ApiSiteBundleInterface
{
    /**
     * @inheritDoc
     */
