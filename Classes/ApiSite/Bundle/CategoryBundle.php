 ...
 *
 * Last modified: 2021.05.19 at 23:43
 */
...
use LaborDigital\T3fa\Resource\Category;

class CategoryBundle implements ApiSiteBundleInterface
{
    /**
     * @inheritDoc
     */
    ...
    {
        $collector->register(Category::class);
    }
