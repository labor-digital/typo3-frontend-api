...
use LaborDigital\Typo3FrontendApi\ApiRouter\Builtin\Strategy\ExtendedApplicationStrategy;
...
class RouteConfigGenerator implements CachedStackGeneratorInterface
{
    ...
    {
        if ($strategy === 'json') {
            return ExtendedJsonStrategy::class;
        }

        if ($strategy === 'raw') {
            return ExtendedApplicationStrategy::class;
        }
